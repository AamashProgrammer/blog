...
// for show blogs  
$select_blog_sql = "SELECT * FROM `blog` LEFT JOIN category ON blog.category = category.cat_id LEFT JOIN user ON blog.author_id = user.user_id WHERE user.user_id = '$user_id' ORDER BY blog.publish_date DESC;";
